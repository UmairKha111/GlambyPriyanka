            ...
            <div className="relative w-72 h-72 sm:w-96 sm:h-96">
              ...
              <div className="absolute -bottom-2 -left-2 bg-[#fbfbfb] dark:bg-[#070707] border border-black/10 dark:border-white/10 rounded-none p-3 shadow-2xl flex items-center space-x-3 max-w-[150px]">
                ...
                <div>
                  ...
                  <span className="block text-[10px] uppercase font-bold tracking-widest text-slate-800 dark:text-white">7+ Year</span>
                </div>
              </div>

              <div className="absolute -top-2 -right-4 bg-[#fbfbfb] dark:bg-[#070707] border border-black/10 dark:border-white/10 rounded-none p-3 shadow-2xl flex items-center space-x-3 max-w-[150px]">
                <div className="flex-shrink-0 w-8 h-8 bg-black/5 dark:bg-white/5 flex items-center justify-center text-slate-700 dark:text-rose-450">
                  <Sparkles className="w-4 h-4" />
                </div>
                <div>
                  <span className="block text-[8px] uppercase tracking-wider font-mono text-slate-400">Accredited</span>
                  <span className="block text-[10px] uppercase font-bold tracking-widest text-slate-800 dark:text-white">Certified</span>
                </div>
              </div>
            </div>
          </motion.div>
